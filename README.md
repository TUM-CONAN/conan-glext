[Conan.io](https://conan.io) package for [glext](https://github.com/zeromq/glext) project
...
### Basic setup
    ...
    $ conan install glext/1.3@camposs/stable
...
## Upload
    ...
    $ conan upload glext/1.3@camposs/stable --all -r camposs
